      ...
      .col-lg-12.col-12.px-lg-5.px-4
        .row.align-items-center.justify-content-center
          ...
          figure(data-aos="fade-down")
            .video
              iframe(width="560" height="315" src="https://www.youtube.com/embed/TE0TKx9dEtI?si=4qX9Jj7tBUqNucDO" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen)
            figcaption Video. Programacion orientada a objetos
